...
const getAllProperties = (options, limit = 10) => {
  ...
  if (options.mininimum_price_per_night && options.maximum_price_per_night) {
    queryParams.push(options.mininimum_price_per_night * 100, options.maximum_price_per_night * 100);
...
const addProperty = function (property) {
  const queryString = `INSERT INTO properties (owner_id, title, thumbnail_photo_url, cover_photo_url, cost_per_night, parking_spaces, number_of_bathrooms, number_of_bedrooms, country, street, city, province, post_code) 
